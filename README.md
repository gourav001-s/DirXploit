...
✔ Scans website directories using a wordlist  
✔ Displays only **HTTP 200 (OK)** directories  
✔ Saves found directories into `results.txt`  
✔ Uses colored terminal output  
✔ Professional ASCII hacker banner  
✔ Easy & beginner-friendly to use
